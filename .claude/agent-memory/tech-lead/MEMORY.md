...
- [ADR-020 depth mount COMMISSIONED](project_adr020-depth-commissioning.md) — D2 8/8 live 2026-09-06; D3 books the corner-clamped 46.0 m, not the 58.0 m optical prefix; far clip stays 60 m; D5/D6 pending
- [A gate is only as true as its scene](project_a-gate-is-only-as-true-as-its-scene.md) — 3rd green-tick-over-nothing: the geometry gate passed 2/8 with its target never teleported; harnesses need self-checks

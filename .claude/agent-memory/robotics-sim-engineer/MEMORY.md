...
- [Recording-throughput levers](recording_throughput_levers.md) — 5→2 Hz measured and DISPROVEN (16x worse); delivery is bursty; instrument fused_count before the next lever.

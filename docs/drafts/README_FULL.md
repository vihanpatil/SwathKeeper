...
| Automated tests | **1599 passed, 1 failed, 2 skipped, 0 xfail** (`python3 -m pytest tests -q`). The single failure is deliberate: the CI evidence gate is red on the committed breach | `tests/README.md`, measured 2026-09-07 — re-run and re-quote if you change the suite |
